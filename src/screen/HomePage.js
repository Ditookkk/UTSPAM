...
const Home = ({navigation}) => {  
    ...
    return (
    <>
        <StatusBar barStyle="light-content" backgroundColor='darkgrey' />
            ...
            <KeyboardAvoidingView>
                <View style={styles.main}>
                    ...
                    <TouchableOpacity
                        style={styles.button}
                        onPress={onSubmit}>
                        <Text style={styles.buttonText}><Icon style={styles.searchicon} name="search" size={15} color="white"/>Cari</Text>
                    </TouchableOpacity>
                </View>
